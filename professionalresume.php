            ...
            <div class="page__inner">
                <div class="page__main">
                    ...
                    <h1 style="margin-bottom: 0px;"><?php echo $fname."\r".$lname; ?></h1>
                        ...
                        <ul>
                            <li>
                                <p style="margin-top: 0px;"><?php if(!empty($uni_ug)) echo "Undergraduation -";?> <span><?php if(!empty($uni_ug)) echo $uni_ug;?></span></p>
                            </li>
                        ...
                        <h2 style="margin-bottom: 0px;"><?php if(!empty($work_exp)) echo "Work Experience"; ?></h2>
